...
<body>
	<div class="wraper">
		<div class="container">
			...
			<form name="join" id="reservation-form" class="login-form" enctype="multipart/form-data">
	    <div class="input-group mb-3">
	        ...
	        <div><button type="button" onclick="check_ID_go();">중복확인</button></div>
				...
				<div class="login-form">
					...
					<span style="font-size:14px;">※이미지는 jpg/jpeg형식과 1MB만 가능합니다.</span></label>
					<br/>
...
function lockFutureDates() {
    ...
    dateInput.setAttribute('max', today); // max 속성 설정
