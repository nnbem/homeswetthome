...
public class TreatmentRegistRequest {
	...
	public String toString() {
		return "TreatmentRegistRequest [aid=" + aid + ", eid=" + eid + ", cure=" + cure + ", disease=" + disease
				+ ", sympton=" + sympton + ", opinion=" + opinion + ", other=" + other + ", treatment_date="
				+ treatment_date + ", disease_date=" + disease_date + ", toTreatment()=" + toTreatment() + "]";
	}
